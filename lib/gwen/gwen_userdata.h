	...
	*/
	class UserDataStorage
	{
		...
		public:
			...
			~UserDataStorage()
			{
				stl::map< Gwen::String, void*>::iterator it = m_List.begin();
				stl::map< Gwen::String, void*>::iterator itEnd = m_List.end();
			...
			void Set( const Gwen::String& str, const T& var )
			{
				...
				stl::map< Gwen::String, void*>::iterator it = m_List.find( str );
				if ( it != m_List.end() )
				{
			...
			stl::map< Gwen::String, void*>	m_List;
	};
