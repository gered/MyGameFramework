#ifndef __FRAMEWORK_FILE_DISKFILE_H_INCLUDED__
#define __FRAMEWORK_FILE_DISKFILE_H_INCLUDED__
...
/**
 * Generic file class using only the C Standard Library for file 
 * I/O operations.
 */
